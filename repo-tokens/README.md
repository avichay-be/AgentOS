...
```yaml
- uses: qwibitai/agentos/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [AgentOS](https://github.com/qwibitai/AgentOS) | ![tokens](https://raw.githubusercontent.com/qwibitai/AgentOS/main/repo-tokens/badge.svg) |
