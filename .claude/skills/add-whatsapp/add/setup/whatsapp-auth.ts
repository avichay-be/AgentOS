...
<html><head><title>AgentOS - WhatsApp Auth</title>
...
<html><head><title>AgentOS - Connected!</title>
<style>
...
<script>localStorage.removeItem('agentos_qr_start');</script>
</body></html>`;
