...
AgentOS gives you the core functionality without that mess.
...
- Custom `agentos` MCP server (inside container) provides scheduling tools
...
**AgentOS** - A reference to Clawdbot (now OpenClaw).
